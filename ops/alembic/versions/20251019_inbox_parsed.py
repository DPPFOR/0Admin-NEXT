...
down_revision: str | None = "251018_schema_v1_inbox"
...
def downgrade() -> None:
    op.drop_index(
        "ix_parsed_item_chunks_parent", table_name="parsed_item_chunks", schema="inbox_parsed"
    )
