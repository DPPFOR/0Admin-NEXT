...
class TestTemplateContract:
    ...
    def test_template_loading_fallback(self, test_config):
        ...
        assert "Zahlungserinnerung" in engine.templates["stage_1"] or "Test Template" in engine.templates["stage_1"]
        assert "2. Mahnung" in engine.templates["stage_2"] or "Test Template" in engine.templates["stage_2"]
        assert "Letzte Mahnung" in engine.templates["stage_3"] or "Test Template" in engine.templates["stage_3"]
