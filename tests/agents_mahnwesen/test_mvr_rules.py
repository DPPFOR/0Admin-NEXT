...
from agents.mahnwesen.mvr import MVREngine, DunningStage, OverdueInvoice
...
class TestMVRRules:
    ...
    def test_determine_stage_within_grace_period(self, mvr_engine, sample_invoice):
        ...
        sample_invoice.due_date = datetime.now(timezone.utc) - timedelta(days=1)
    ...
    def test_determine_stage_1(self, mvr_engine, sample_invoice):
        ...
        sample_invoice.due_date = datetime.now(timezone.utc) - timedelta(days=10)
    ...
    def test_determine_stage_2(self, mvr_engine, sample_invoice):
        ...
        sample_invoice.due_date = datetime.now(timezone.utc) - timedelta(days=20)
    ...
    def test_determine_stage_3(self, mvr_engine, sample_invoice):
        ...
        sample_invoice.due_date = datetime.now(timezone.utc) - timedelta(days=40)
    ...
    def test_should_send_recent_dunning(self, mvr_engine, sample_invoice):
        ...
        sample_invoice.last_dunning_sent = datetime.now(timezone.utc) - timedelta(hours=12)
