...
def test_shadow_analysis_mail_path_guards(monkeypatch):
    ...
    try:
        mod.run_shadow_analysis(
            tenant_id="t", trace_id="x", source_uri_or_path="artifacts/inbox/../../etc/passwd", content_sha256=""
        )
        assert False, "expected ValueError"
    except ValueError:
        pass
    ...
    out = mod.run_shadow_analysis(
        tenant_id="t", trace_id="x", source_uri_or_path="artifacts/inbox/samples/images/sample.png", content_sha256=""
    )
