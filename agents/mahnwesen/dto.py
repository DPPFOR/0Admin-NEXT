...
class OverdueInvoice:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        return {
            ...
            "last_dunning_date": (
                self.last_dunning_date.isoformat() if self.last_dunning_date else None
            ),
    ...
    def from_dict(cls, data: dict[str, Any]) -> "OverdueInvoice":
        ...
        return cls(
            ...
            last_dunning_date=(
                datetime.fromisoformat(data["last_dunning_date"].replace("Z", "+00:00"))
                if data.get("last_dunning_date")
                else None
            ),
...
class DunningNotice:
    ...
    notice_ref: str | None = None  # For backward compatibility with tests
